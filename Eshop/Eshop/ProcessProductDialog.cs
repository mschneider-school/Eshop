...
namespace Eshop
{
    public partial class ProcessProductDialog : Form
    {
        ...
        private Product BuildProductFromDetails()
        {
            ...
            string cathegory = ProductCathegoryCBox.Text;

            string priceString = ProductPriceTextBox.Text;
            int price = Convert.ToInt32(priceString);

            Image photo = ProductPictureBox.Image;
            string description = ProductDescriptionRTBox.Text;
        ...
        // oznac barevne spatne vyplnena pole, vrat vysledek validity
        private bool VerifyEntries()
        {
            ...
            foreach (Control control in entryControls)
            {
                ...
                {
                    control.Parent.BackColor = Color.MistyRose;
                    allValid = false;
                }
            }
            return allValid;
        ...
        private void ShowInvalidEntriesWarning()
        {
